...
Este projeto tem como objetivo simular de forma simples e prática o controle de uma conta bancária, permitindo operações básicas como entrada e saída de valores, consulta de saldo e finalização da aplicação.
